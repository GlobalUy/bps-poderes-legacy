    ...
    public partial class Form1 : Form
    {
        ...
        private void btnTest_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // ********************************************************************************************************************************************
                //server = Interaction.CreateObject("Bull.PRES.Jubi.DesafiliacionAfapCincuentones.Facades.BusinessFacade", this.cboServidor.Text);
                //Bull.PRES.Jubi.DesafiliacionAfapCincuentones.Facades.BusinessFacade root = null;
                //root = (Bull.PRES.Jubi.DesafiliacionAfapCincuentones.Facades.BusinessFacade)server;
                //Bull.PRES.Jubi.DesafiliacionAfapCincuentones.Facades.Persona retorno = root.ObtContextoPersona(Convert.ToInt32(1234), "", DateTime.Now, co);
                ...
                // CODIGO DE EJEMPLO PARA INVOCAR LA SOLUCION
                // ********************************************************************************************************************************************
                server = Interaction.CreateObject("Bull.PRES.Poderes.ServiceAgents.SAFuncionarios", this.cboServidor.Text);
                Bull.PRES.Poderes.ServiceAgents.SAFuncionarios root = null;
                Contexto co = new Contexto();
                co.FechaOpera = DateTime.Today;
                co.Debug = 0;
                co.UsuarioActual = "BPSRING";
                root = (Bull.PRES.Poderes.ServiceAgents.SAFuncionarios)server;
                //ResultObtenerFuncionarioPorCedula retorno = root.ObtFuncionario("52018530","DO", "1", co);
                //salidaXML = GetXMLFromObject(retorno);
                //CargoXML(salidaXML);
                // ********************************************************************************************************************************************
