    ...
    public partial class Form1 : Form
    {
        ...
        private void btnTest_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // ********************************************************************************************************************************************
                server = Interaction.CreateObject("Bull.PRES.Poderes.Adapters.AdapterDotNet", this.cboServidor.Text);
                Bull.PRES.Poderes.Adapters.AdapterDotNet root = null;
                root = (Bull.PRES.Poderes.Adapters.AdapterDotNet)server;
                var retorno = root.ObtOrigenesPoderes("P", co.UsuarioActual, co.FechaOpera, co.Debug);
                if (((object[,])(((object[])(retorno))[1]))[0, 0] == null)
                {
